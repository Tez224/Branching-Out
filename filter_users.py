...
if __name__ == "__main__":
    filter_option = input("What would you like to filter by? (Currently, only 'name', 'age', 'email'): ").strip().lower()
    ...
    if filter_option == "email":
        email_to_search = input("Enter an mail to filter users: ").lower()
